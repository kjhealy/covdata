...
These data tables are taken from [the GitHub repository](https://github.com/nytimes/covid-19-data) maintained by _New York Times_ staff. The information in this article mostly repeats the content of their [REAME](https://github.com/nytimes/covid-19-data/blob/master/README.md) file.
